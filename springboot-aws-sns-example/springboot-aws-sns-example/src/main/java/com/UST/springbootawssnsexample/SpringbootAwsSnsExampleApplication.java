...
public class SpringbootAwsSnsExampleApplication {
	...
	String TOPIC_ARN="arn:aws:sns:ap-south-1:303201338734:javafullstack-topic" ;
	...
	private String buildEmailBody(){
		return "Dear Employee ,\n" +
				"\n" +
				"\n" +
				"Connection down Trivandrum."+"\n"+
				"All the servers in Trivandrum Data center are not accessible. We are working on it ! \n" +
